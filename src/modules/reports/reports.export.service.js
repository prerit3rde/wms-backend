...
exports.generateExcel = async (data, reportType, financialYear) => {
  ...
  const columns = [
    ...
    { header: "20% Deduction Amount against 1% gain", key: "deduction_20_percent" },
    ...
    { header: "Other Deduction Reason", key: "other_deductions_reason" },
  ...
  data.forEach((item, index) => {
    const rowData = {
      ...
      month: item.month || (item.from_date ? new Date(item.from_date).toLocaleString("en-IN", { month: "long" }) : ""),
      ...
      other_deductions_reason: item.other_deductions_reason || "",
